...
<div class="container-fluid py-4">
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            ...
            <p class="text-muted">view seller Details.</p>
        </div>
            ...
            <div class="card bg-primary text-white admin-buyers-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="card-title text-white mb-0">More about Seller </h5>
                            @if (session('success'))
                                ...
                                @if ($seller)
                                    <tr>
                                        ...
                                        <td class="text-center admin-buyers-btn-group">
                                            <form action="{{route('deleteUser',['user'=>$seller->id])}}">
                                                @csrf @method('delete')
...
<div class="container-fluid py-4">
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            ...
            <p class="text-muted">view seller Orders.</p>
        </div>
        <div class="col-md-6 d-flex justify-content-md-end">
            <div class="input-group" style="max-width: 300px;">
                <input type="text" class="form-control" placeholder="Search buyers..." aria-label="Search buyers">
