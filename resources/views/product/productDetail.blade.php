...
@section('pageName', 'About Product')
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <button class=" add-to-cart-btn btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"data-product-id={{$product->id}}><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                            </div>
                            <div class="col-lg-12">
                                <nav>
                                            ...
                                            <div class="row g-4">
                                                <div class="col-6">
                                                    ...
                                                    <div class="row text-center align-items-center justify-content-center py-2">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="mb-0">{{$product->price_per_kg}}</p>
                                                        </div>
                                                    </div>
